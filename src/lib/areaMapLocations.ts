...
const COORDINATES: Record<string, AreaMapCoordinate> = {
  ...
  "busot": { lat: 38.4814, lng: -0.4203 },
  "busott": { lat: 38.4814, lng: -0.4203 },
  ...
  "jumilla": { lat: 38.4762, lng: -1.3270 },
  "jumella": { lat: 38.4762, lng: -1.3270 },
  ...
  "el fondo de les neus": { lat: 38.3089, lng: -0.8534 },
