    ...
    <main lang="es">
      ...
      <PortalSignedOutOnly>
        <section className="page-hero compact-hero">
          ...
          <p>Accede de forma segura a la información que compartimos contigo durante la búsqueda y compra de tu vivienda en España.</p>
        </section>
        ...
        <section className="section">
          ...
          <div style={{ maxWidth: 760, margin: "24px auto 0", textAlign: "center" }}>
            <p style={{ color: "var(--muted)", lineHeight: 1.7 }}>El acceso se habilita personalmente para clientes de Zen Eco Homes. No creamos cuentas públicas automáticamente.</p>
            <Link className="text-button" href="/es#contacto"><ShieldCheck size={17} /> ¿Necesitas acceso? Contacta con nosotros</Link>
          </div>
        </section>
      </PortalSignedOutOnly>
